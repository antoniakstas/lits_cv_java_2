...
//    public static final String DB_TABLE_PRODUCT = "product";
    ...
    public static void main(String[] args) {
        ...
        productDal.createProductInToDB(productToInsert);
        System.out.println("");
        productDal.readAllFromDB();
        System.out.println("");

        int idValueToUpdate = 13;
        productDal.updateProduct(idValueToUpdate);
        productDal.readAllFromDB();
        System.out.println("");

        productDal.deleteProduct(idValueToUpdate);
        productDal.readAllFromDB();
