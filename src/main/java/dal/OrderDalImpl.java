...
import java.util.Optional;
    ...
    public class OrderDalImpl implements OrderDal {
        ...
        public static final String DB_COLUMN_USER_M_ID = "user_m_id";
        public static final String DB_COLUMN_USER_C_ID = "user_c_id";
        public static final String DB_TABLE_ORDER = "order";
        ...
        public boolean createOrderInToDB(Order order) {
            try {
                ...
                String insertTableSQL = "INSERT INTO " + DB_TABLE_ORDER
                        ...
                        + "("+order.getId()+",'"+order.getStatus()+"','"+order.getUser_m_id()+"','"+order.getUser_c_id()+"' )";
